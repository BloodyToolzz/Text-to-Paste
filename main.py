...
def check_for_changes():
    if __author__ != '\u0042\u006c\u006f\u006f\u0064\u0079\u0023\u0036\u0038\u0035\u0030': # Checks if you changed the __author__ text field
        Write.Print("Bro imagine changing the author value, stop skidding pls.", Colors.red_to_yellow, interval=0.008)
        pause()
        exit
...
text = Write.Input(f"[{timenow}] | Enter Text: ", Colors.purple_to_blue, interval=0.008)
time.sleep(2)
...
Write.Print(f"[{timenow}] | Opening in browser in 3 seconds...", Colors.rainbow, interval=0.008)
time.sleep(1)

cls()
Write.Print(f"[{timenow}] | Link: {paste_text}\n", Colors.green_to_blue, interval=0)
Write.Print(f"[{timenow}] | Opening in browser in 2 seconds...", Colors.rainbow, interval=0.008)
time.sleep(1)
...
cls()    
Write.Print(f"\n[{timenow}] | Exiting . . .", Colors.red_to_blue, interval=0.008)
exit